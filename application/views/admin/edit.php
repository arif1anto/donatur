<div class="grid-form">
	<div class="grid-form1">
		...
		<?php echo form_open_multipart('admin/admin/edit/'.$admin['id_admin'],array("class"=>"form-horizontal")); ?>
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<!-- <input type="text" name="foto_admin" value="<?php echo ($this->input->post('foto_admin') ? $this->input->post('foto_admin') : $admin['foto_admin']); ?>" class="form-control" id="foto_admin" /> -->
